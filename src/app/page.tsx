...
import { ArrowRight, Gauge, KeyRound, LayoutDashboard, QrCode } from "lucide-react";
    ...
    <main className="px-6 py-10 md:px-10 space-y-8">
      ...
      <section className="glass-panel rounded-3xl p-6 border border-white/10 grid md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl bg-white/5 border border-white/10 p-5 space-y-3">
          <div className="text-sm uppercase tracking-[0.2em] text-slate-400">Қарапайым қолжетімділік</div>
          <div className="flex items-center gap-3">
            <div className="h-12 w-12 rounded-xl bg-primary/30 flex items-center justify-center">
              <QrCode />
            </div>
            <div>
              <p className="font-semibold">QR Check-in admin ішінде</p>
              <p className="text-slate-400 text-sm">Сканерлеу және қолмен тексеру бір жерде</p>
            </div>
          </div>
        </div>
      </section>
